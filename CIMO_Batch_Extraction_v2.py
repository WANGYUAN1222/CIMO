...
if __name__ == "__main__":
    ...
    # 跑 Qwen3
    # batch_extract(ROOT, "qwen3", "./cimo_results/results_qwen3_v2.jsonl", sleep_sec=3.0)

    # batch_extract(ROOT, "deepseek", "./cimo_results/results_deepseek_v2.jsonl", sleep_sec=3.0)
    batch_extract(ROOT, "glm-5", "./cimo_results/results_glm-5_v2.jsonl", sleep_sec=3.0)
